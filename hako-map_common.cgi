...
sub islandInfo {
    ...
    <th $HbgTitleCell>${HtagTH_}<small>総合Point</small>${H_tagTH}</th>
END
        $rStr2 = <<END;
...
$bStr
  <tr>
$rStr1
    <th class='TitleCell'>${HtagTH_}天候${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}<small>次ターン<br>天候予想</small>${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}気温${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}人口${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}面積${H_tagTH}</th>
$mStr1
    <th class='TitleCell'>${HtagTH_}食料${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}農場${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}職場${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}HT職場${H_tagTH}</th>
    <th class='TitleCell'>${HtagTH_}採掘場${H_tagTH}</th>
$uStr1
    <th class='TitleCell'>${HtagTH_}軍事<br>技術${H_tagTH}</th>
$msStr1
    <th class='TitleCell'>${HtagTH_}要望/数値${H_tagTH}</th>
  </tr>
  <tr>
$rStr2
...
sub islandItemData {
  ...
  <table border>
    <tr>
      <th class='TitleCell' align="center" rowspan="2"><span class='head'>持ち物</span></th>
END
...
END
  ...
  <div class='ExtContainer'>
        <table border>
          ...
          <tr>
            <th $HbgTitleCell align='center' colspan='1'>${HtagTH_}試合${H_tagTH}</th>
            <th $HbgTitleCell align='center' colspan='3'>${HtagTH_}通算(勝率)${H_tagTH}</th>
            <th $HbgTitleCell align='center' colspan='1'>${HtagTH_}優勝${H_tagTH}</th>
          </tr>
            <td $HbgInfoCell align='center' colspan='1'>$stwin勝$stlose敗$stdrow分</td>
            <td $HbgInfoCell align='center' colspan='3'>$stwint勝$stloset敗$stdrowt分($shoritu%)</td>
            <td $HbgInfoCell align='center' colspan='1'>$styusho回</td>
          <tr>
          </tr>
        </table>
  </div>
...
<div class='ExtContainer'>
  <table border="1">
    ...
    <tr>
      ...
      <td $HbgTitleCell align='center'>${HtagTH_}撃破${H_tagTH}</td>
      <td $HbgTitleCell align='center'>${HtagTH_}経験値${H_tagTH}</td>
    </tr>
    <tr>
